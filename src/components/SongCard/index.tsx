...
import { Container, Image, MusicInfos, PlayButton, PlayControl, TagGenre, HeartIcon } from './styles';

import { SongsCard } from './types';

export const SongCard: React.FC<SongsCard> = ({ image, name, author, desc, genre, id, audio, favMusic, changeFavStatus})=> {
